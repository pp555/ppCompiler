...
namespace AstNodes
{
	...
	{
	public:
		ForStmt(AstNode *codeBlock, AstNode *initialization, AstNode *condition, AstNode *afterthought)
			: AstNode(NodeType::ForStmt), _codeBlock(codeBlock), _init(initialization), _condition(condition), _after(afterthought)
		{
		}
